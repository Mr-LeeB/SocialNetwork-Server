...
const UpdateUser = async (req, res) => {
  ...
  const { firstname, lastname, tags, contacts, username, userImage, coverImage } = req.body;

  const user = { firstname, lastname, tags, contacts, username, userImage, coverImage };
